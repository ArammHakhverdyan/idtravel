    ...
    const hotels = [
        {
            ...
            description: <p>DiliJazz Hotel & Restaurant features a restaurant, bar, a shared lounge and garden in Dilijan. With free WiFi, this 4-star hotel offers a 24-hour front desk and room service. The hotel has family rooms.
        ...
        },
        {
            ...
            description: <p>With a façade featuring exposed stone and wood, this hotel is located in Sharambeyan Street, in the historic district of Dilijan. All rooms at Tufenkian feature 19th-century décor and a flat-screen satellite TV.
        ...
        },
        {
            ...
            description: <p>Surrounded by the pine forest on the bank of the river, Villa Jrvezh offers accommodation in Dilijan, a 30-minute drive to Lake Sevan. The guest house has a terrace and a sun terrace, and guests can enjoy a meal at the restaurant or a drink at the bar. Lake Parz is a 20-minute drive away.
                                    ...
                                    <Typography variant="body2" color="textSecondary">
                                        <Accordion>
                                            <AccordionSummary
                                                ...
                                                id="panel1a-header"
                                            >
                                                <Typography className={classes.heading} style={{ fontSize: "15px" }}>View description</Typography>
                                            </AccordionSummary>
                                            <AccordionDetails>
                                                <Typography>
                                                    {value.description}
